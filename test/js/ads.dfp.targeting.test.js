...
function tests() {
    ...
    test("test getDFPTargeting FT.env.dfp_targeting undefined", function () {
        ...
        ok(targetingValue == undefined, 'targetValue is not undefined')
    ...
    test("test getDFPTargeting unencoded to encoded", function () {
        ...
        var targetingValue = FT.ads.getDFPTargeting();
        ok(targetingValue == 'peo=fran%C3%A3%C2%A7ois%20hollande:bashar%20al-assad;pt=ind', 'targetValue is ok')
    });
    ...
    test("test getDFPTargeting encoded to doubleEndcoded", function () {
        ...
        var targetingValue = FT.ads.getDFPTargeting();
        ok(targetingValue == 'peo=fran%25c3%25a7ois%2520hollande:bashar%2520al-assad', 'targetValue does not match')
