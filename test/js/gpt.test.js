/* jshint strict: false */
/* globals googletag:false, jQuery: false, FT, deepEqual: false, equal: false, expect: false, ok: false, QUnit: false, strictEqual: false, test: false, TEST: false */
...
(function (window, document, $, undefined) {
	function runTests() {
		...
		test('define with images sizes', function () {
			...
			var stubOnSlot = FT.ads.slots['responsive-mpu'].gptSlot;
			expect(2);
		...
		test('define without images sizes', function () {
			...
			var stubOnSlot = FT.ads.slots['no-responsive-mpu'].gptSlot;
			expect(2);
		...
		test('fix the url for ad requests', function () {
			...
			slot = FT.ads.slots['canonical-slot'];
