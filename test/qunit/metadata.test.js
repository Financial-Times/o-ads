...
QUnit.test("getLoginInfo method warns it has been deprecated", function(assert) {
	var warn = this.spy(this.utils.log, 'warn');
	var result = this.ads.metadata.getLoginInfo();
	assert.deepEqual(result, {}, "An empty object is returned");
...
QUnit.test("getAyscVars method warns it has been deprecated", function(assert) {
	var warn = this.spy(this.utils.log, 'warn');
	var result = this.ads.metadata.getAyscVars();
	assert.deepEqual(result, {}, "An empty object is returned");
...
QUnit.test("getPageType method warns it has been deprecated", function(assert) {
	var warn = this.spy(this.utils.log, 'warn');
	var result = this.ads.metadata.getPageType();
	assert.deepEqual(result, {}, "An empty object is returned");
