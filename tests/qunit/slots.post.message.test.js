...
let errorStub;
describe('Slots - post message', function () {
	beforeEach(function() {
	...
	it('Post message whoami message reply is sent', function (done) {
	...
	it('Post message whoami message with collapse will call slot collapse', function (done) {
	...
	it('Post message whoami message with isMaster will fire event on companion slots', function (done) {
	...
	it('Post message from unknown slot logs an error and sends a repsonse', function (done) {
	...
	it('Post message collapse calls the collapse method on the slot', function (done) {
	...
	it('Post message responsive tells the slot a responsive creative is loaded', function (done) {
	...
	it('Post message resize message fire the resize event', function (done) {
	...
	it('Passed touch fires an event', function (done) {
	...
	it('Post message replies with correct disable default swipe handler parameter if config is present on attribute', function (done) {
	...
	it('Post message replies with correct disable default swipe handler parameter if config is present in slot config', function (done) {
	...
	it('Post message replies with correct disable default swipe handler parameter if config is present in global config', function (done) {
	...
	it('Post message catches the event when the message comes not from a slot that is does not exist', function (done) {
