...
describe('ads API config', function () {

	it('resolves with an empty promise if called without any urls', function (done) {
	...
	it('can handle errors in the api response', function (done) {
	...
	it("makes api call to correct user url and adds correct data to targeting", function (done) {
	...
	it("does not overwrite existing data in user config", function (done) {
	...
	it("makes api call to correct page/content url and adds correct data to targeting", function (done) {
	...
	it("makes use of custom set timeout when calling getPageData directly", function (done) {
	...
	it("does not overwrite existing data in page config", function (done) {
	...
	it('overwrites the config gpt zone with the adunit from the page response if "usePageZone" is true', function (done) {
	...
	it('does not overwrite the config gpt zone with the adunit from the page response by default', function (done) {
	...
	it('does not overwrite the config gpt zone if using adUnit instead of site/zone', function (done) {
	...
	it("allows single page app to update the user targeting from API on the fly", function (done) {
	...
	it("Single Page app can update page context data", function (done) {
	...
	it.skip("allows single page app to update the concept targeting from API on the fly", function (done) {
