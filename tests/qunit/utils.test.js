...
describe('utils.isType methods', function () {
	...
	it('Utils object exists', function () {
	...
	it('isNonEmptyString method', function () {
	...
	it('isPlainObject method', function () {
...
describe('utils.extend', function () {
	...
	it('attach method success', function (done) {
	...
	it('attach method supports auto removing script', function (done) {
	...
	it('attach method failed', function (done) {
	...
	it('attach method failedi with only an error callback specified', function (done) {
	...
	it('fail nicely when cannot find a name of the ad from an iframe', function () {
	...
	it('find a name of the ad from an iframe', function () {
	...
	it("builds an object from array", function () {
		const array = [{
			"name": "subscription",
			"key": "slv",
			"value": "int"
	...
	it("getQueryParamByName", function () {
