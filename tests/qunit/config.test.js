...
describe('config', function () {
	...
	it('Config get/set - mulitple', function () {
	...
	it('Config fetchDeclaritive', function () {
	...
	it('Config fetchDeclaritive, multiple script tags', function () {
	...
	it('Config deep extends so default options like formats aren\'t overwritten', function () {
		this.ads.init();
	...
	it('Config works as expected even when there are custom prototype methods defined (e.g. polyfill)', function () {
