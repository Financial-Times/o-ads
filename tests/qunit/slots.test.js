...
describe('Slots', function () {
	...
	it('fails nicely if not slots found', function () {
	...
	it('moves id attribute to data-o-ads-name attribute instead', function () {
	...
	it('generates new name for a slot', function () {
	...
	it('adds an aria-hidden attribute on a slot', function () {
		const node = this.fixturesContainer.add('<div data-o-ads-sizes="600x300,300x600,720x30"></div>');
		this.ads.init();
		const slot = this.ads.slots.initSlot(node);
	...
	it('sets all attributes on slot object', function () {
		const node = this.fixturesContainer.add('<div data-o-ads-sizes="600x300,300x600,720x30"></div>');
		this.ads.init();
		const slot = this.ads.slots.initSlot(node);
	...
	it('catches when the ads format is not correct', function () {
	...
	it('catches when the ads sizes are not correct', function () {
	...
	it('creates add based on a format with multiple sizes defined', function () {
	...
	it('allows fluid as a creative format size', function () {
	...
	it('allows fluid as a slot size', function () {
	...
	it('converts false string value of a property to a boolean', function () {
	...
	it('defaults empty string value of a property to a true boolean', function () {
	...
	it('create a basic slot with js configuration', function () {
	...
	it('create a slot with sizes via sizes attribute', function () {
	...
	it('create a slot with an invalid size among multiple sizes', function () {
	...
	it('create a slot with sizes via format attribute', function () {
	...
	it('Label right container', function () {
	...
	it('Label container via attribute', function () {
	...
	it('configure out of page slot', function () {
	...
	it('configure out of page slot via DOM', function () {
	...
	it('configure slot level targeting', function () {
	...
	it('Slots.collapse will collapse a single slot', function () {
	...
	it('Slots.collapse will collapse mulitple slots', function () {
	...
	it('Slots.collapse with no args will collapse all slots', function () {
		const node1 = this.fixturesContainer.add('<div data-o-ads-name="collapse1-test" data-o-ads-formats="MediumRectangle"></div>');
		const node2 = this.fixturesContainer.add('<div data-o-ads-name="collapse2-test" data-o-ads-formats="MediumRectangle"></div>');
	...
	it('Slots.collapse will emit an event', function () {
	...
	it('Slots.uncollapse will uncollapse a single slot', function () {
		const node = this.fixturesContainer.add('<div data-o-ads-name="collapse-test" data-o-ads-formats="MediumRectangle"></div>');
	...
	it('Slots.uncollapse will uncollapse mulitple slots', function () {
		const node1 = this.fixturesContainer.add('<div data-o-ads-name="collapse1-test" data-o-ads-formats="MediumRectangle"></div>');
		const node2 = this.fixturesContainer.add('<div data-o-ads-name="collapse2-test" data-o-ads-formats="MediumRectangle"></div>');
	...
	it('Slots.uncollapse with no args will collapse all slots', function () {
		const node1 = this.fixturesContainer.add('<div data-o-ads-name="collapse1-test" data-o-ads-formats="MediumRectangle"></div>');
		const node2 = this.fixturesContainer.add('<div data-o-ads-name="collapse2-test" data-o-ads-formats="MediumRectangle"></div>');
	...
	it('Slots.refresh will refresh a single slot', function (done) {
	...
	it('Slots.destroy will destroy a single slot', function () {
	...
	it('Slots.destroy will call clear slot method from the ad server provider when one is present', function () {
		const node = this.fixturesContainer.add('<div data-o-ads-name="destroy-test" data-o-ads-formats="MediumRectangle"></div>');
		const slot = this.ads.slots.initSlot(node);
		assert.ok(this.ads.slots['destroy-test'], 'slot to be destoryed has been initialised');
	...
	it('Slots.destroy will destroy multiple slots', function () {
	...
	it('Slots.clear will clear a single slot', function () {
	...
	it('Slots.clear will call clear slot method from the ad server provider when one is present', function () {
		const node = this.fixturesContainer.add('<div data-o-ads-name="clear-test" data-o-ads-formats="MediumRectangle"></div>');
		const slot = this.ads.slots.initSlot(node);
		assert.ok(this.ads.slots['clear-test'], 'slot to be cleared has been initialised');
		// provide mock method on slot (usually responosbility of ad server provider)
	...
	it('Slots.clear will clear multiple slots', function () {
	...
	it('Slots.submitImpression will submit and impression for a single slot', function () {
	...
	it('attempting to run an action on an unknown slot will log a warning', function () {
	...
	it('attempting to run an action on a non-slot log a warning', function () {
		const warnSpy = this.spy(this.utils.log, 'warn');
		this.ads.slots['test'] = {};
		this.ads.slots.clear();
	...
	it('configure refresh globally on a timer', function (done) {
	...
	it('configure refresh globally on a timer with a default time of 1 second', function (done) {
	...
	it('configure refresh on a timer for a max number of times', function () {
		const clock = this.date();
		const slotHTML = '<div data-o-ads-name="refresh-test" data-o-ads-formats="Rectangle"></div>';
		const node = this.fixturesContainer.add(slotHTML);
		let count = 0;
	...
	it('lazy loading global config', function (done) {
	...
	it('lazy loading slot config takes precedence over global config', function () {
	...
	it('lazy loading triggers event if the advert is in view', function (done) {
	...
	it('lazy loading triggers in top-down order if multiple ads in view', function (done) {
	...
	it('lazy loading supports in view threshold', function (done) {
	...
	it('lazy loading supports slot level config', function () {
	...
	it('lazy loading works with old DOM slot level configuration', function () {
	...
	it('lazy loading allows multiple thresholds to be configure from DOM data attribute', function () {
	...
	it('lazy loading passes threshold to IntersectionObserver', function () {
	...
	it('lazy loading only works if explicitely told to do so', function () {
	...
	it('lazy loading supports global config', function () {
		const slotHTML = `<div data-o-ads-name="lazy-test" data-o-ads-formats="MediumRectangle"></div>`;
		const node = this.fixturesContainer.add(slotHTML);
		const config = {
			lazyLoad: {
	...
	it('lazy loading triggers event at the correct point with no intersection observer viewport margin set', function (done) {
	...
	it('lazy loading triggers event at the correct point with intersection observer viewport margin is set', function (done) {
	...
	it('lazy loading a companion slot', function (done) {
	...
	it('companion slots which are configured as false for a specific screensize should not render at that screensize', function () {
	...
	it('lazy loading loads the ad normal way if IntersectionObserver is not available', function () {
	...
	it('complete events fire', function (done) {
	...
	it('debug logs creatives', function () {
