...
function gptVideoURL(pos, vkv) {
	var URL;
	var additionalAdTargetingParams; var fullURL;
	var gpt = config('gpt');
	var buildCustomParams = function(vkv) {
		var allTargeting = targeting.get();
		var results = '';
		var kruxSegs = allTargeting.ksg;
		var includeParams = ['playlistid', 'playerid', '07', 'ksg', '06', 'slv', 'eid', '05', '19', '21', '27', '20', '02', '14', 'cn', '01', 'rfrsh', 'dcopt', 'brand', 'section', 'lnID', 'specialBadging', 'kuid'];
		var i;
